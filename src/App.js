  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <ProtectedRoute exact path="/cashflow" auth={props.auth} expenses={expenses} component={ComingSoon} currentDate={currentDate} changeCurrentDate={changeCurrentDate} isLoading={isLoading} setIsLoading={setIsLoading} currentAccount={currentAccount} />
        <ProtectedRoute exact path="/chart" auth={props.auth} expenses={expenses} component={Chart} currentDate={currentDate} changeCurrentDate={changeCurrentDate} isLoading={isLoading} setIsLoading={setIsLoading} currentAccount={currentAccount} />
